...
# Corrige PATH caso o shell esteja rodando em ambiente limitado (como pipenv)
...
alias pir='f() { pip3 install -r requirements.txt };f' # instala dependencias do requirement
